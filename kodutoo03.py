...
while True:
    kujund = input("mida tahad joonistada (viisnurk, ring, ruut, suvaline)? ")
    kogus = int(input("mitu tükki joonistan? "))
    ...
    jatkata = input("vajuta enterit, kui tahad lõpetada: ")
    if jatkata == "":
        print("vaata nüüd oma joonistust")
        break
